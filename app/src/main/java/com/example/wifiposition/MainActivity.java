        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.btnInit:
                    ...
                    Toast.makeText(MainActivity.this, "going to init", Toast.LENGTH_SHORT).show();
                ...
                case R.id.btnUnregist:
                    ...
                    Toast.makeText(MainActivity.this, "removeUpdates", Toast.LENGTH_SHORT).show();
                    break;
                case R.id.btnUninit:
                    ...
                    mTextView2.setText("请先初始化引擎");
                    Toast.makeText(MainActivity.this, "going to destroy", Toast.LENGTH_SHORT).show();
                    break;
                default:
                    break;
            }
